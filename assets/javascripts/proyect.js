...
const projects = [
  {
    title: "Modelo de ventas para FEMSA 2022",
    cardImage: "assets/images/project-page/quiz.jpg",
    description: "Analisis de ventas en el sector minorista. En el sector minorista, la exhibición de los productos en la tiendas puede tener un gran impacto en las ventas y en la merma. En este estudio, analizamos el impacto de la variable exhibición en la venta y la merma de una tiendas retail en México. Se busca entender cómo la exhibición afecta a estas variables es de gran importancia para la empresa, ya que les permitiría optimizar la disposición de los productos en la tienda para mejorar la venta y reducir la merma. Para ello, utilizamos un modelo econométrico lineal múltiple que nos permitió analizar la relación entre la exhibición y las variables de interés. Los resultados de nuestro estudio podrían ser útiles para la empresa de tiendas minoristas al momento de tomar decisiones empresariales informadas para mejorar la eficiencia y la rentabilidad..",
